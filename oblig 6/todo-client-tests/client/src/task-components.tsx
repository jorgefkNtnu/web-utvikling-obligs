  ...
  render() {
    return (
      <>
          ...
          <Row>
            ...
            <Column>
              <Form.Checkbox
                ...
                onChange={(event) => {
                  this.task.done = event.currentTarget.checked;
                }}
              />
            </Column>
          </Row>
        ...
        <Row>
          <Column>
            <Button.Success onClick={() => this.editTask(this.task)}>Save</Button.Success>
          </Column>
          <Column right>
            <Button.Danger onClick={() => this.deleteTask(this.task.id)}>Delete</Button.Danger>
          </Column>
        </Row>
      </>
    );
